...
def load_sheets(role):
    ...
    allowed_sheets = get_allowed_sheets(all_sheets, role)
...
if len(sheet_names) == 0:
    st.error("No sheets available for this role")
    st.stop()
